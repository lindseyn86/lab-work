 ...
 *
 * ↓ YOUR CODE HERE ↓ */
let myGreeting = new Greeting('Lindsey', 'VA')
myGreeting.hello()
...
let yourBook = new Book('11/22/63', 'Stephen King')
...
class Fruit{
  ...
  description() {
    return `A ${this.name} tastes ${this.taste} and is ${this.color} in color.`
  }
}
...
const movie1 = new Movie("Jurassic Park", "Steven Spielberg");
const movie2 = new Movie("How the Grinch Stole Christmas", "Ron Howard");
